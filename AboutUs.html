...
<div class="about-content">
    ...
    <div class="about-border">
        <div class="about-body">
            ...
            <ul>
                <li><span>نام پروژه :</span> همراه سفر</li>
                <li><span>موضوع پروژه :</span> معرفی رستوران های معروف شهر های ایران</li>
                <li><span>تهیه کنندگان :</span> ریحانه ابراهیمی نسب - مبینا محبی</li>
                <li><span>زبان های اسفاده شده :</span> PHP - MySQL - HTML - CSS</li>
                <li><span>درس :</span> برنامه نویسی مبتنی بر وب</li>
                <li><span>استاد :</span> سرکار خانم سارا نخعی</li>
            </ul>
        </div>
    </div>
</div>
